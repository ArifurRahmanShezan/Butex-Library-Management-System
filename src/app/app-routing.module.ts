...
const routes: Routes = [
  ...
  { path: 'Catalogue-Template', component: Trail2Component },
  { path: 'Bibliography', component: Trail3Component },
  { path: 'Catalogue-Item', component: Trail4Component },
  { path: 'Books-Approval', component: RequestAdminComponent },
